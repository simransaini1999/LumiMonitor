...
public class Graph_Temperature extends AppCompatActivity {
    ...
    private void drawGraph() {
        ...
        BarDataSet dataset = new BarDataSet(entrylist, getString(R.string.rawtemp));
    ...
    private void setupTitleandHomeButton() {
        getSupportActionBar().setSubtitle(R.string.TempGraph);
